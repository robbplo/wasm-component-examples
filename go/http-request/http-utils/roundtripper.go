...
// Copied from https://github.com/wasmCloud/go/blob/main/component/net/wasihttp/roundtripper.go
...
import (
	...
	monotonicclock "http-request/gen/wasi/clocks/v0.2.6/monotonic-clock"
	outgoinghandler "http-request/gen/wasi/http/v0.2.6/outgoing-handler"
...
func (r *Transport) RoundTrip(incomingRequest *http.Request) (*http.Response, error) {
	...
	Resolve(futureResponse.Subscribe())
